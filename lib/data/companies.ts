...
export const COMPANIES: Company[] = [
  ...
  },
  {
    ...
    blurb: "Pseudocode, English writing and a game-based aptitude assessment ahead of technical and HR rounds.",
    cutoffPRI: 52,
    slope: 0.85,
    eligibility: {
      cgpa: "60% / 6.0 CGPA across 10th, 12th, UG",
      ...
      tenthTwelfth: "Minimum 60% in 10th and 12th",
      pattern: [
        "Game-based aptitude assessment: Numerical, Logical and Verbal Ability",
        "Pseudocode test (programming logic, no syntax)",
        "Written English / essay assessment",
      ],
      rounds: ["Online assessment", "Technical Interview", "HR Interview"],
  ...
  },
  {
    ...
    name: "EPAM Systems",
    short: "EPAM",
    accent: "oklch(0.58 0.2 145)",
    sector: "Product Engineering / IT Services",
    blurb: "Programming-fundamentals heavy - a logic/coding assessment followed by hands-on technical interviews.",
    cutoffPRI: 62,
    slope: 0.8,
    eligibility: {
      cgpa: "60%+ typical; strong programming fundamentals prioritized",
      backlogs: "No active backlogs",
      tenthTwelfth: "Minimum 60% in 10th and 12th",
      pattern: [
        "Online logical reasoning + programming/coding assessment",
        "Technical interview: OOP, DSA and language fundamentals",
        "HR / culture-fit discussion",
      ],
  ...
  },
  {
    ...
    name: "IBM",
    short: "IBM",
    accent: "oklch(0.5 0.16 260)",
    sector: "Technology / Consulting",
    blurb: "Aptitude and problem-solving assessment, then a technical interview and HR round.",
    cutoffPRI: 55,
    slope: 0.85,
    eligibility: {
      cgpa: "60% / 6.0 CGPA aggregate, no standing arrears",
      ...
      pattern: [
        ...
        "Problem-solving / coding assessment",
  ...
  },
  {
    ...
    blurb: "Standard aptitude and technical-fundamentals screening with a smaller, focused hiring drive.",
    cutoffPRI: 50,
    slope: 0.85,
    eligibility: {
      cgpa: "60% / 6.0 CGPA aggregate",
  ...
  },
  {
    ...
    blurb: "Aptitude, logical and verbal assessment with a technical and HR round - strong telecom-domain hiring.",
    cutoffPRI: 50,
    slope: 0.85,
    eligibility: {
      cgpa: "60% / 6.0 CGPA across 10th, 12th, UG",
  ...
  },
  {
    ...
    name: "HCLTech",
    short: "HCLTech",
    accent: "oklch(0.5 0.19 255)",
    sector: "IT Services",
    blurb: "Aptitude and technical-fundamentals MCQ assessment, then technical and HR rounds.",
    cutoffPRI: 50,
    slope: 0.85,
    eligibility: {
      cgpa: "60% / 6.0 CGPA aggregate",
